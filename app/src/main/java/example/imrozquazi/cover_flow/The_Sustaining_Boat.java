...
public class The_Sustaining_Boat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the__sustaining__boat);

        mAuth=FirebaseAuth.getInstance();

        mbook = (Button)findViewById(R.id.button_the_sustaining_boat);
    ...
    private void Datacheck()
    {
        ...
        DatabaseReference dr = FirebaseDatabase.getInstance().getReference().child("CIVIL").child("SustainingBoat").child(uid);
    ...
    private void DataEntry() {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("CIVIL").child("SustainingBoat").child(uid);
        ...
        mDatabase.setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    String message="Thank you "+ StudentInfo.getname()+" for registering in The Sustaining Boat. Kindly show this message/email on payment desk to confirm your booking. This email is valid until bookings are full.";

                    //Toast.makeText(getApplicationContext(),email+" ",Toast.LENGTH_LONG).show();

                    SendMail sm = new SendMail(The_Sustaining_Boat.this, email, subject, message);
