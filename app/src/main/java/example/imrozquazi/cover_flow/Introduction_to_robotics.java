...
public class Introduction_to_robotics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introduction_to_robotics);

        mAuth=FirebaseAuth.getInstance();


        mbook = (Button)findViewById(R.id.button_intro_robotics);
    ...
    private void Datacheck()
    {
        ...
        DatabaseReference dr = FirebaseDatabase.getInstance().getReference().child("Open").child("Intro to Robotics").child(uid);
    ...
    private void DataEntry() {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Open").child("Intro to Robotics").child(uid);
        ...
        mDatabase.setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    String message="Thank you "+ StudentInfo.getname()+" for registering in Introduction to Robotics. Kindly show this message/email on payment desk to confirm your booking. This email is valid until bookings are full.";

                    //Toast.makeText(getApplicationContext(),email+" ",Toast.LENGTH_LONG).show();

                    SendMail sm = new SendMail(Introduction_to_robotics.this, email, subject, message);
    ...
    public void smsApiCall()
    {
        try {
            ...
            String message = "&message=" + "Thank you "+ StudentInfo.getname()+" for registering in Introduction to Robotics. Kindly show this message/email on payment desk to confirm your booking.";
