...
public class Element_Sorting extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_element__sorting);

        mAuth=FirebaseAuth.getInstance();


        mbook = (Button)findViewById(R.id.button_element_sorting);
    ...
    private void Datacheck()
    {
        ...
        DatabaseReference dr = FirebaseDatabase.getInstance().getReference().child("Fun").child("Element Sorting").child(uid);
    ...
    private void DataEntry() {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Fun").child("Element Sorting").child(uid);
        ...
        mDatabase.setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    String message="Thank you "+ StudentInfo.getname()+" for registering in Element Sorting. Kindly show this message/email on payment desk to confirm your booking. This email is valid until bookings are full.";

                    //Toast.makeText(getApplicationContext(),email+" ",Toast.LENGTH_LONG).show();

                    SendMail sm = new SendMail(Element_Sorting.this, email, subject, message);
    ...
    public void smsApiCall()
    {
        try {
            ...
            String message = "&message=" + "Thank you "+ StudentInfo.getname()+" for registering in Element Sorting. Kindly show this message/email on payment desk to confirm your booking.";
