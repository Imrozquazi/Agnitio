...
public class The_Quiz extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the__quiz);

        mAuth=FirebaseAuth.getInstance();


        mbook = (Button)findViewById(R.id.button_quiz);
    ...
    private void Datacheck()
    {
        ...
        DatabaseReference dr = FirebaseDatabase.getInstance().getReference().child("Open").child("Quiz").child(uid);
    ...
    private void DataEntry() {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("Open").child("Quiz").child(uid);
