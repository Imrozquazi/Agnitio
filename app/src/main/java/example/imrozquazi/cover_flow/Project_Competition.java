...
public class Project_Competition extends AppCompatActivity {
    ...
    private void Datacheck()
    {
        ...
        DatabaseReference dr = FirebaseDatabase.getInstance().getReference().child("Open").child("Project Competition").child(uid);
        ...
        mDatabase.setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if(task.isSuccessful())
                {
                    ...
                    String message="Thank you "+ StudentInfo.getname()+" for registering in Project Competition. Kindly show this message/email on payment desk to confirm your booking. This email is valid until bookings are full.";

                    //Toast.makeText(getApplicationContext(),email+" ",Toast.LENGTH_LONG).show();

                    SendMail sm = new SendMail(Project_Competition.this, email, subject, message);
    ...
    public void smsApiCall()
    {
        try {
            ...
            String message = "&message=" + "Thank you "+ StudentInfo.getname()+" for registering in Project Competition. Kindly show this message/email on payment desk to confirm your booking.";
