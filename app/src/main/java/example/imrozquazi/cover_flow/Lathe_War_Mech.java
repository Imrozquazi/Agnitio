...
public class Lathe_War_Mech extends AppCompatActivity {
    ...
    private void Datacheck()
    {
        ...
        DatabaseReference dr = FirebaseDatabase.getInstance().getReference().child("MECH").child("LatheWar").child(uid);
    ...
    private void DataEntry() {
        ...
        DatabaseReference mDatabase = FirebaseDatabase.getInstance().getReference().child("MECH").child("LatheWar").child(uid);
    ...
    public void smsApiCall()
    {
        try {
            ...
            String message = "&message=" + "Greetings from team TechFest, Thank you for registering in LATHE WAR " + StudentInfo.getname()+ ".";
